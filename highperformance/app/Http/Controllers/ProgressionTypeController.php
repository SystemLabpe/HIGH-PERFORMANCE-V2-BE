...
use App\ProgressionType;
use Illuminate\Http\Request;
use Log;

class ProgressionTypeController extends Controller{

    public function all(){
        $list = ProgressionType::where('active',config('active.ACTIVE'))
            ->get();
