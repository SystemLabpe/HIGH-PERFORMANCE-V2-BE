...
use App\InitialPenetration;
use Illuminate\Http\Request;
use Log;

class InitialPenetrationController extends Controller{

    public function all(){
        $list = InitialPenetration::where('active',config('active.ACTIVE'))
            ->get();
    ...
    public function edit(Request $request,$id){
        $obj = InitialPenetration::find($id);
        if(!$obj){
